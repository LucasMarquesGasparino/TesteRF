...
Instruções: 
	...
	1 - executar o servidor para MongoDB com mongod.exe (Diretório padrão: "C:\Program Files\MongoDB\Server\3.4\bin\mongod.exe") 
	...
	4 - acessar o servidor local, pois é lá que está hospedada a página web.